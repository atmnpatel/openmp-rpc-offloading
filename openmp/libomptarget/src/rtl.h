...
struct RTLInfoTy {
  ...
  typedef int32_t (*register_requires_ty)(int64_t);
  ...
  register_requires_ty register_requires = nullptr;
  ...
  RTLInfoTy(const RTLInfoTy &r) {
    ...
    register_lib = r.register_lib;
    unregister_lib = r.unregister_lib;
    register_requires = r.register_requires;
  }
};
